    ...
    $.spriteAnimator = function (element, options) {
        ...
        plugin.init = function () {
            ...
            if (options.cols === undefined) {
                throw 'spriteAnimator: cols not set';
            }
            if (options.rows === undefined) {
                throw 'spriteAnimator: rows not set';
            }
        ...
        var _drawFrame = function (frame) {
            if (frame.sprite === plugin.playhead.currentSprite) {
                return false;
            }
            ...
            if (frame.top != undefined) {
                $element.css('top', ($element.position().top + frame.top) + 'px');
            }
            if (frame.bottom != undefined) {
                $element.css('bottom', ($element.position().bottom + frame.bottom) + 'px');
            }
            if (frame.left != undefined) {
                $element.css('left', ($element.position().left + frame.left) + 'px');
            }
            if (frame.right != undefined) {
                $element.css('right', ($element.position().right + frame.right) + 'px');
            }
